...
global specular
global specref
ambientLight = (0.3, 0.2, 0.6, 1.0)
diffuseLight = (0.7, 0.7, 0.7, 0.7)
specular = (1.0, 1.0, 1.0, 1.0)
specref = (30.0, 10.0, -10.0, 1.0)
...
def desenhaEsfera(g):
    ...
    for i in range(n):
        for j in range(n):
            glTexCoord2f(j/n,i/n); glNormal3f(0.0,0.0,1.0); glVertex3fv(f(i,j,g))
            glTexCoord2f(j/n,(i+1)/n); glNormal3f(0.0,0.0,1.0); glVertex3fv(f(i+1,j,g))
    glEnd()
...
def keyboard(key, x, y):
    if (key == chr(27)): # tecla 'n'
        xrot, yrot = 0
    elif key == chr(27) or key == chr(71): # tecla 'escape' or 'q'
        sys.exit()
